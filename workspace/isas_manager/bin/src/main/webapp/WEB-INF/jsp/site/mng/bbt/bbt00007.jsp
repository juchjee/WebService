...
<script type="text/javaScript" defer="defer">
	var contUrl = "${rootUri}${conUrl}bbt00007";
	...
	var _columns = [
		...
		,{ text: '번호', datafield: 'num', cellclassname: cellclass, width: '5%', cellsalign: 'center', align: 'center'}
		,{ text: '부품명', datafield: 'boardTitle', cellclassname: cellclass, width: '30%', cellsalign: 'left', align: 'center'}
		,{ text: '가격', datafield: 'prodPrice', cellclassname: cellclass, width: '15%', cellsalign: 'center', align: 'center'}
		,{ text: '구매처', datafield: 'prodPurch', cellclassname: cellclass, width: '25%', cellsalign: 'center', align: 'center'}
		,{ text: '전화번호', datafield: 'prodTel', cellclassname: cellclass, width: '15%', cellsalign: 'center', align: 'center'}
		,{ text: '수정', datafield: 'popButton', width: '5%', cellsalign: 'center', align: 'center',
			columntype: 'button', cellsrenderer: function () { 
                ...
                var dataRecord = $("#jqxgrid").jqxGrid('getrowdata', row);
					$.fancybox.open({
						href: "bbt00007R.action?boardMstCd=${boardMstCd}&boardSeq="+ dataRecord.boardSeq,
						type: "iframe",
						maxWidth	: 1920,
						maxHeight	: 1100,
						width		: 1000,
	...
	var _datafields = [
		...
		,{ name: 'prodPurch', type: 'string'}
		,{ name: 'prodTel', type: 'string'}
	...
	function fnEvent(){
		...
		$("#registBtn").click(function(){
			$("#registBtn").attr("href","bbt00007R.action?boardMstCd=${boardMstCd}");
		});
		...
		$("#jqxgrid").on('celldoubleclick', function (event)
				{
					...
					$("#boardSeq").val(datarow.boardSeq);
						setTimeout(function(){
							$("#modifyBtn").attr("href","bbt00007R.action?boardMstCd=${boardMstCd}&boardSeq="+datarow.boardSeq);
							$("#modifyBtn").click();
						},200);
					}
				});
		...
		$("#btnExcel").on('click', function(){
			grideExportExcel('jqxgrid','부품구매목록');
		});
		...
		$(".delBtn").click(function(){
			...
			if(confirm("삭제하시겠습니까?")){
				fnAjax("bbt00001D.action",  {"data":$.paramData}, function(data, dataType){
