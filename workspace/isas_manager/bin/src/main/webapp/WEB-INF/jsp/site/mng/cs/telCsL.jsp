...
<script type="text/javaScript" defer="defer">
	var contUrl = "${rootUri}${conUrl}telCsL";
	...
	var _columns = [
		...
		,{ text: '모델', datafield: 'modelNm',  width: '7%', cellsalign: 'left', align: 'center'}
		...
		,{ text: '수정', datafield: 'popButton', width: '5%', cellsalign: 'center', align: 'center',
			columntype: 'button', cellsrenderer: function () {
                ...
                var dataRecord = $("#jqxgrid").jqxGrid('getrowdata', row);
					$.fancybox.open({
						href: "telCsR.action?asTempNo=" + dataRecord.asTempNo,
						type: "iframe",
						maxWidth	: 1920,
						maxHeight	: 1100,
						width		: 1000,
	...
	function fnEvent(){
		...
		$("#registBtn").click(function(){
			$("#registBtn").attr("href","telCsR.action?boardMstCd=${boardMstCd}");
		});
		...
		$("#jqxgrid").on('celldoubleclick', function (event)
				{
					if(event.args.datafield != 'chk'){
						...
						var datarow = $('#jqxgrid').jqxGrid('getrowdata', rowBoundIndex);
							setTimeout(function(){
								$("#modifyBtn").attr("href","telCsR.action?asTempNo="+datarow.asTempNo);
								$("#modifyBtn").click();
							},200);
					}
				});
