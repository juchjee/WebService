...
<script type="text/javascript">
	...
	var contUrl = "${rootUri}${conUrl}amM1028";

	function init(){

		var obj = $(".gnb > ul >li > a")[7];
		$(obj).addClass("on");
	...
	function fnEvent(){
		...
		$("#jqxgrid").on('rowdoubleclick', function (event)
		{
			...
			$.fancybox.open({
				href: "/mng/bbt/bbt00006R.action?boardMstCd=BBM00007&boardSeq="+datarow.boardSeq,
				type: "iframe",
				maxWidth	: 1920,
				maxHeight	: 1100,
				width		: 1000,
