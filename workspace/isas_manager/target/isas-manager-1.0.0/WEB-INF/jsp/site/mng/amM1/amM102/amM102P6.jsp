...
<script type="text/javascript">
	...
	var contUrl = "${rootUri}${conUrl}amM1026";

	function init(){

		var obj = $(".gnb > ul >li > a")[5];
		$(obj).addClass("on");
	...
	function fnEvent(){
		...
		$("#jqxgrid").on('rowdoubleclick', function (event)
		{
			...
			$.fancybox.open({
				href: "/mng/bbt/bbt00002R.action?boardMstCd=BBM00003&boardSeq="+datarow.boardSeq,
				type: "iframe",
				maxWidth	: 1920,
				maxHeight	: 1100,
				width		: 1000,
	...
	<div class="member_detail_con">
		...
		<div class="grid_type1" style="padding-top:10px;">
			<div id="jqxgrid"></div>
		</div>
