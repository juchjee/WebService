        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div class="fl_td">
                  <html:selectList name='refundInstCd' id='refundInstCd' list='${accountInst}' listValue='accountInstCd' listName='accountInstNm' defaultValue="${orderInfo.accountInstCd}"  script=' style="width:150px;"'/>
                </div>
                <div class="fl_td">
                        ...
                        <c:when test="${claimProcess.prevStep eq 'P'}">
                          <c:choose>
                            <c:when test="${claimProcess.claimProcWp eq 'W'}">
                              ...
                              <c:choose>
                                <c:when test="${orderInfo.claimTpCd eq 'OCT00004'}">
                                 ${orderInfo.orderCashNm} - 환불 예정 금액 : <input type="text" class="validation[number]" name="refundCharge" id="refundCharge" value="${orderInfo.orderSum}" />
                                </c:when>
                                <c:otherwise>
                                환불 예정 금액 : <input type="text" class="validation[number]" name="refundCharge" id="refundCharge" value="${orderInfo.orderSum - sumPrice}" />
                                </c:otherwise>
