...
<script type="text/javaScript" defer="defer">
	var contUrl = "${rootUri}${conUrl}bbt00010";
	...
	var _columns = [
		...
		,{ text: '칭찬대상자', datafield: 'recomName',  width: '10%', cellsalign: 'center', align: 'center'}
		,{ text: '작성자', datafield: 'regId',  width: '10%', cellsalign: 'center', align: 'center'}
		,{ text: '등록일', datafield: 'regDt',  width: '10%', cellsalign: 'center', align: 'center'}
