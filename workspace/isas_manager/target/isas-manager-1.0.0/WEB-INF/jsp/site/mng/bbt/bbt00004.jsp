...
<script type="text/javaScript" defer="defer">
	...
	var contUrl = "${rootUri}${conUrl}bbt00004";
	...
	var _columns = [
	       		...
	       		, { text: '번호', datafield: 'num', cellclassname: cellclass, width: '10%', cellsalign: 'center', align: 'center'}
	     		,{ text: '분류', datafield: 'boardCateNm', cellclassname: cellclass, width: '10%', cellsalign: 'center', align: 'center'}
	     		,{ text: '제목', datafield: 'boardTitle', cellclassname: cellclass, width: '45%', cellsalign: 'left', align: 'center'}
	     		,{ text: '작성자', datafield: 'regId', cellclassname: cellclass, width: '10%', cellsalign: 'center', align: 'center'}
	     		,{ text: '등록일', datafield: 'regDt', cellclassname: cellclass, width: '15%', cellsalign: 'center', align: 'center'}
	     		,{ text: '수정', datafield: 'popButton', width: '5%', cellsalign: 'center', align: 'center',
	    			columntype: 'button', cellsrenderer: function () {
	                    ...
	                    var dataRecord = $("#jqxgrid").jqxGrid('getrowdata', row);
	    					$.fancybox.open({
	    						href: "bbt00004R.action?boardMstCd=${boardMstCd}&boardSeq="+ dataRecord.boardSeq,
	    						type: "iframe",
	    						maxWidth	: 1920,
	    						maxHeight	: 1100,
	    						width		: 1000,
	...
	function fnEvent(){
		...
		$("#registBtn").click(function(){
			$("#registBtn").attr("href","bbt00004R.action?boardMstCd=${boardMstCd}");
		});
		...
		$("#jqxgrid").on('celldoubleclick', function (event)
				{
					...
					$("#boardSeq").val(datarow.boardSeq);
						setTimeout(function(){
							$("#modifyBtn").attr("href","bbt00004R.action?boardMstCd=${boardMstCd}&boardSeq="+datarow.boardSeq);
							$("#modifyBtn").click();
						},200);
					}
				});
...
<body>
	...
	<div class="pageContScroll_st2">
		<div class="top_box">
			<form id="workForm" name="workForm" action="bbt00004R.do?boardMstCd=${boardMstCd}" method="post">
