	...
	<div class="popup_wrap">
		...
		<div class="pageContScroll_st4">
			...
			<form id="workForm" name="workForm" action="csSave.action" method="post" >
				...
				<input type="hidden" name="itmGubun" id="itmGubun" value="${csInfo.itmGubun}" />
						...
						<tr>
							...
							<td>
								<select id="reTy" name="reTy" class="validation[required]" title="접수유형" style="width:100px;">
									...
									<option value="AS200100">상담처리</option>
									<option value="AS200200" selected="selected">A/S처리</option>
...
<!-- 								<select id="model" name="model" class="validation[required]" title="모델" style="width:200px;"></select> -->
							</td>
						</tr>
						<tr>
