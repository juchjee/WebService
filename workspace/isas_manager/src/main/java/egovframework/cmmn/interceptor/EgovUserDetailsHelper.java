...
public class EgovUserDetailsHelper {
	...
	public void setEgovUserDetailsService(EgovUserDetailsService userDetailsService) {
		egovUserDetailsService = userDetailsService;
	}
	...
	public static String getAdmId(){
		return egovUserDetailsService.getAdmId();
	}
	 ...
	 * @return
	 */
	public static String getAdmAuthCd(){
		return egovUserDetailsService.getAdmAuthCd();
	}
	 ...
	 * @return
	 */
	public static String getAdmLoginIp(){
		return egovUserDetailsService.getAdmLoginIp();
	}
