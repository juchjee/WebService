...
<%-- 				<c:if test="${boardMstCd ne 'BBM00050'}">수정</c:if> --%>
<!-- 			</a> -->
			
			<c:if test="${empty viewMap.boardSeq}"><a class="btn_blue_line2" href="javascript:;" onclick="$.submit();">등록</a></c:if>
			<c:if test="${boardMstCd ne 'BBM00050'}"><a class="btn_blue_line2" href="javascript:;" onclick="$.submit();">수정</a></c:if>
		</div>
	</div>
	</div>
	<!-- // table_type2 -->
