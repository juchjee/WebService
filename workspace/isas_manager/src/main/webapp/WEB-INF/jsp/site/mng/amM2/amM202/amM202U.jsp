...
function fnDataSetting(){
	// root 카테고리 초기로
	  ...
	  $("#prodProgressQty").text(setComma("${prodInventory.prodProgressQty}")+" 개"); //판매진행수
		...
		fnGridCodeMpg("workForm","prodMpg",null);
		  //--------------------------------------------------- 초기화 기본 데이터 End --------------------------------------------------
}
...
<!-- 		  <div class="fr"><a class="fancybox bis btn_type1" data-fancybox-type="iframe" href="prodAddInfo.action?tp=set">상품 추가정보 편집</a></div> -->
		         ...
		         <c:forEach items="${prodAddInfoList}" var="prodAddInfo">
		          <tr>
			          ...
			          <td>
						...
						<c:choose>
							<%-- 문자타입 일때 --%>
							<c:when test="${prodAddInfo.prodAddTpSn eq 'S' }"><input type="text"  name="prodAddInfoVal" style="width:600px" value="${prodAddInfo.prodAddInfoVal}" /></c:when>
							<%-- 숫자타입 일때 --%>
		        ...
		        <tr>
		          ...
		          <td colspan="3">
		            ...
		            <div class="marT10">
		              ...
		              <span class="marL30">상세이미지<input type="text" name="prodBasicSizeBmsPx" class="marLR20 alignR validation[number]" style="width:55px;"  value="607" />픽셀</span>
		              <span class="marL30">리스트이미지<input type="text"  name="prodBasicSizeBmsPx"  class="marLR20 alignR validation[number]" style="width:55px;" value="607" />픽셀</span>
		              <span class="marL30">주문리스트이미지<input type="text" name="prodBasicSizeBmsPx" class="marLR20 alignR validation[number]" style="width:55px;" value="105" />픽셀</span>
		            </div>
		          </td>
		        </tr>
		      ...
		      <tbody>
		        ...
		        <tr  class="tpP">
		         ...
		         <tr>
		          ...
		          <td>
		            <input type="text" name="prodWearingQty" class="marR5 alignR validation[number]" placeholder="0" title="추가입고" /> 개
		          </td>
		        </tr>
		        <tr>
		  ...
		  <div class="btn_area">
		    <div class="center">
		     <a class="btn_blue_line2" href="amM202.do" >계속등록</a><a class="btn_blue_line2" href="javascript:;" onclick="$.submit();">수정</a>
		    </div>
		  </div>
</body>
