			...
			.extend(
					a.jqx._jqxComboBox.prototype,
					{
						...
						render : function() {
							...
							n.host.append(g);
							n.dropdownlistWrapper = n.host
									.find("#dropdownlistWrapper");
							n.dropdownlistArrow = n.host
									.find("#dropdownlistArrow");
							n.dropdownlistContent = n.host
									.find("#dropdownlistContent");
							n.dropdownlistContent.addClass(n
									.toThemeProperty("jqx-combobox-content"));
							n.dropdownlistContent.addClass(n
									.toThemeProperty("jqx-widget-content"));
							n.dropdownlistWrapper[0].id = "dropdownlistWrapper"
									+ n.element.id;
							n.dropdownlistArrow[0].id = "dropdownlistArrow"
									+ n.element.id;
							n.dropdownlistContent[0].id = "dropdownlistContent"
									+ n.element.id;
							n.dropdownlistContent
									.append(a('<input autocomplete="off" style="margin: 0; padding: 0; padding-left: 3px; padding-right: 3px; border: 0;" type="textarea"/>'));
							...
							try {
								...
								n.container = b;
								n.listBoxContainer = a(a.find("#innerListBox"
										+ n.id));
								var d = n.width;
								...
								n.container
										.height(parseInt(n.dropDownHeight) + 25);
								n.addHandler(n.listBoxContainer,
										"bindingComplete", function(e) {
											if (!n.listBox) {
												n.listBox = a.data(
														n.listBoxContainer[0],
														"jqxListBox").instance
											}
											n._raiseEvent("6")
										});
											...
											rendered : function() {
												...
												if (n.remoteAutoComplete) {
													if (n.autoDropDownHeight) {
														n.container
																.height(n.listBox.virtualSize.height + 25);
														n.listBoxContainer
																.height(n.listBox.virtualSize.height);
														n.listBox._arrange()
													} else {
														n.listBox._arrange();
														n.listBox
														...
														n.listBox
																._renderItems();
														n.container
																.height(n.listBoxContainer
																		.height() + 25)
													}
													if (n.searchString != undefined
															&& n.searchString.length >= n.minLength) {
														var e = n.listBoxContainer
																.jqxListBox("items");
														if (e) {
															if (e.length > 0) {
																if (!n
								...
								n.listBoxContainer.css("border-top-width",
										"1px");
								n.listBoxContainer.addClass(n
										.toThemeProperty("jqx-popup"));
								if (a.jqx.browser.msie) {
									n.listBoxContainer.addClass(n
											.toThemeProperty("jqx-noshadow"))
								}
								n.listBox = a.data(n.listBoxContainer[0],
										"jqxListBox").instance;
							...
							n.dropdownlistArrowIcon.addClass(n
							...
							n.dropdownlistArrow.addClass(n
							...
							n._setSize();
							n._updateHandlers();
							n.addHandler(n.input, "keyup.textchange", function(
									e) {
								var t = n._search(e);
								if (n.cinput && n.input) {
									if (!n.displayMember) {
							...
							if (a.jqx.browser.msie && a.jqx.browser.version < 8) {
								if (n.host.parents(".jqx-window").length > 0) {
									var o = n.host.parents(".jqx-window").css(
											"z-index");
									b.css("z-index", o + 10);
						...
						_search : function(m) {
							...
							if (d.searchMode == "none" || d.searchMode == null
									|| d.searchMode == "undefined") {
								return
							}
							if (m.keyCode == 16 || m.keyCode == 17
									|| m.keyCode == 20) {
								return
							}
							if (d.checkboxes) {
							...
							if (d.multiSelect) {
								var n = a("<span style='visibility: hidden; white-space: nowrap;'>"
										+ d.input.val() + "</span>");
								...
								var f = parseInt(this._findPos(d.host[0])[1])
										+ parseInt(d.host.outerHeight()) - 1
										+ "px";
								var o = a.jqx.mobile.isSafariMobileBrowser()
										|| a.jqx.mobile.isWindowsPhone();
								if ((o != null && o)) {
									f = a.jqx.mobile.getTopPos(this.element)
											+ parseInt(d.host.outerHeight());
							...
							if (m.keyCode == "13") {
								...
								if (m.keyCode == "27") {
									...
									if (!d.isOpened() && !d.opening
											&& !m.ctrlKey) {
										if (d.listBox.visibleItems
												&& d.listBox.visibleItems.length > 0) {
											if (d.input.val() != d.searchString
													&& d.searchString != undefined
													&& c != -1) {
									...
									if (!d.isanimating) {
										if (f) {
											...
											if (d.autoDropDownHeight) {
												d.container
														.height(d.listBoxContainer
																.height() + 25);
												var g = d.listBoxContainer
						...
						showListBox : function(l) {
							...
							var m = parseInt(this._findPos(this.host[0])[1])
									+ parseInt(this.host.outerHeight()) - 1
									+ "px";
							var d, q = parseInt(Math.round(this.host
									.coord(true).left));
							d = q + "px";
							var u = a.jqx.mobile.isSafariMobileBrowser()
									|| a.jqx.mobile.isWindowsPhone();
							this.ishiding = false;
							var g = a.jqx.utilities.hasTransform(this.host);
							if (g || (u != null && u)) {
								d = a.jqx.mobile.getLeftPos(this.element);
								m = a.jqx.mobile.getTopPos(this.element)
										+ parseInt(this.host.outerHeight());
								if (a("body").css("border-top-width") != "0px") {
									m = parseInt(m) - this._getBodyOffset().top
											+ "px"
								}
								if (a("body").css("border-left-width") != "0px") {
									d = parseInt(d)
						...
						propertyChangedHandler : function(b, c, f, e) {
							...
							if (c == "placeHolder") {
								b.input.attr("placeholder", b.placeHolder)
							}
							if (c == "popupZIndex") {
