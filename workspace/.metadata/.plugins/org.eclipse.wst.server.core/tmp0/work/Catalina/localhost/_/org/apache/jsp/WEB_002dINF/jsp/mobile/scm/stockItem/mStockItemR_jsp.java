 ...
 * Generated at: 2018-11-29 07:37:47 UTC
...
public final class mStockItemR_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\tfields: [\r\n");
      out.write("\t\t\t\t\t\t\t\t{ width: 120, label: '품목코드'\t, template: '#itmCd#'\t, type: 'custom', align: 'center'},\r\n");
      out.write("\t\t\t\t\t\t\t\t//\t{ width: 65\t, label: '총합'\t\t, template: '#tot#'\t\t, type: 'custom', align: 'right'},\r\n");
      out.write("\t\t\t\t\t\t\t\t{ width: 80\t, label: '재고량'\t, template: function(obj){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar tot = addComma(obj.tot);\r\n");
      out.write("\t\t\t\t\t\t\t\t\treturn tot;\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\tvar url = \"/mobile/scm/stockItem/mStockItemGrdDtlR.do?stdDt=\" + $$('stdDt').getValue() + \"?itmCd=\" + list.itmCd + \"?itmNm=\" + list.itmNm + \"?facCd=\" + $$('facCd').getValue() + \"?itmInfo=\" + $$('itmInfo').getValue();\r\n");
