...
$(document).ready(function(){
	...
	gridMain.addHeader({name:"대분류",  colId:"kbigDs", width:"100", align:"center", type:"ro"});
 ...
 function fn_search(){
	 gfn_callAjaxForGrid(gridMain,{},"/erp/scm/work/partners/dailyWork/constructionS/itemCodePop",subLayout.cells("a"),fn_loadGridListCodeCB);
 }
...
<input name="appvKind" id="appvKind" type="hidden" >
