...
$(document).ready(function(){
 ...
 function fn_search(){
	 ...
	 $('#appvKind').val(PARAM_INFO.kind);
	 var obj = {}; 
	 obj.siteCd =  $('#siteCd').val();
	 obj.settKind = $('#appvKind').val();
	 gfn_callAjaxForGrid(gridMain,obj,"/erp/scm/work/partners/dailyWork/dailyAttendApproval/perNoKindPop",subLayout.cells("a"),fn_loadGridListCodeCB);
 }
