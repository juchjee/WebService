...
$(document).ready(function(){
	...
	var len = layout.cells("c").getHeight() - 5;	//그리드 사이의 5px 빼고 [724]
	
	subLayout.cells("a").showHeader()
    subLayout.cells("a").setText("출하품목정보")
	subLayout.cells("a").setHeight((len*0.7).toFixed(1));	//소수점 1자리까지
    ...
    subLayout.cells("b").setHeight((len*0.3).toFixed(1));
