					...
					function(data, dataType){
						if($("#ascodeLev1").val() == ""){
							if(data.length > 0){
								...
								$("#ascodeLev1").addClass("validation[required]");
								$("#ascodeLev2").addClass("validation[required]");
							}else{
							//    itmGubunList model
								$("#ascodeLev1").removeClass("validation[required]");
								$("#ascodeLev2").removeClass("validation[required]");
...
// 				$.lvalue = "m3";
			...
			if($(this).index() == 4){
				...
				$("#modelItemCd").val("4"); //이누스바스 코드4번 고정
				$.lvalue = "";
				$("#itmGubun").val("");
				$("#itmGubunList").val("");
				$("#bathType").show();
...
// 				$("#model").html("<option value=''>품목 먼저 선택하세요</option>");
// 				$("#ascodeLev1").html("<option value=''>품목 먼저 선택하세요</option>");
// 				$("#ascodeLev2").html("<option value=''>품목 먼저 선택하세요</option>");
				$("#itmGubunList").addClass("validation[required]");
				return;
			}else{
				$("#itmGubunList").removeClass("validation[required]");
				$("#bathType").hide();
				$("#modelType").show();
				$("#ascodeLevType").show();
			}
...
// 						}
// 						$("#model").addClass("validation[required]");
// 					}else{
// 						$("#modelType").hide();
// 						$("#model").removeClass("validation[required]");
// 					}
...
<body>
	...
	<div class="sub">
		...
		<div class="guide_btn_list">
			...
			<a href="/ISDS/bbt/bbt00008.do?pageCd=BBM00075" class="mvi"><strong class="hv">동영상 가이드</strong><span>쉽고 간단한 영상 조치방법</span></a>
		</div>
		<!--// guide_btn_list -->
		...
		<div class="tblType01 mt30">
			<table>
				...
				<tbody>
					<tr id="bathType" style="display:none;">
						<th scope="row" class="star"><label for="itmGubunList">품목선택</label></th>
						<td>
							<div class="select_bx">
								<select name="itmGubunList" id="itmGubunList" title="품목" >
...
<!-- 							</div> -->
							<div id='modelList' name="modelList"></div>
						</td>
					</tr>
					<tr id="ascodeLevType">
