...
<!-- 			<p class="desc">이누스 이용약관입니다.</p> -->
			<p class="desc">이누스 주식회사 이용약관입니다.</p>
...
<!-- 				<p class="txt">이 약관은 아이에스동서가 운영하는 A/S 웹사이트(이하 “사이트”이라 한다.)에서 제공하는 인터넷 관련서비스 (이하 “서비스”라 한다.)를 이용함에 있어  -->
				<p class="txt">이 약관은 이누스주식회사가 운영하는 A/S 웹사이트(이하 “사이트”이라 한다.)에서 제공하는 인터넷 관련서비스 (이하 “서비스”라 한다.)를 이용함에 있어 
...
<!-- 					<li><span class="num">①</span>“사이트”이란 아이에스동서가 일정 서비스를 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 서비스를 이용할 수 있도록  -->
					<li><span class="num">①</span>“사이트”이란 이누스주식회사가 일정 서비스를 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 서비스를 이용할 수 있도록 
