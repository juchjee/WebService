...
<!-- 	</div> -->
	...
	<div class="sub">
		...
		<div class="cont_bx">
			<h3>제품별 서비스 기준</h3>
			<ul>
				<li>당사는 기본적으로 출장서비스를 진행하고 있습니다.</li>
				<li>단, 일부 품목은 택배수리로만 진행하고 있으니 자세한 문의는 고객센터 대표번호로 연락주시기 바랍니다.</li>
			</ul>
		</div>
		...
		<div class="cont_bx">
			...
			<dl>
				<dt>출장서비스</dt>
				<dt>출장비+수리비+부품비의 합으로 청구됩니다.</dt>
				
				<dd>출장비는 출장수리를 요구하는 경우 적용되며 지역별로 차등 청구됩니다.</dd>
				<dd>수리비는 유료 수리 시 부품비를 제외한 기술료를 말합니다.</dd>
				<dd>부품비는 수리 시 부품 교체를 할 경우 소요되는 부품가격을 말합니다.</dd>
			</dl>
			<dl>
				<dt>택배서비스</dt>
				<dt>택배비+수리비+부품비의 합으로 청구됩니다.</dt>
				
				<dd>택배비는 센터로 제품을 입고시켜 수리 후 다시 고객 지역까지 배달하는 비용입니다. (택배사 요금 기준에 준함)</dd>
				<dd>수리비는 유료 수리 시 부품비를 제외한 기술료를 말합니다.</dd>
				<dd>부품비는 수리 시 부품 교체를 할 경우 소요되는 부품가격을 말합니다.</dd>
				<dd>운송 중 발생하는 파손 및 분실에 대해서는 제조사에서 보상하지 않습니다.</dd>
			</dl>
		</div>
