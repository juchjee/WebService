...
<head>
	...
	<!--
		...
		function fnDataSetting(){
			var sum = ${repairStateView.repAmt}+${repairStateView.btAmt}+${repairStateView.insAmt};

			if("${repairStateView.amtTyCd}" == " AS215100"){
				$("#custAmt").html(0);
				$("#tot").html(setComma(sum));
			}else{
				sum = sum+${repairStateView.custAmt};
				$("#custAmt").html(setComma("${repairStateView.custAmt}"));
				$("#tot").html(setComma(sum));
			}
...
<body>
	<section class="sub cont">
		...
		<!--// ing_bx(A/S접수) -->
		<c:if test="${repairStateView.statBc ne 'AS204100'}">
		<div class="ing_bx view">
			<div class="box">
