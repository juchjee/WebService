...
<body class="noBg" style="height:562px;">
	 <form id="workForm" name="workForm" action="/mng/popup/smsSendPop.action" method="post" >
	 	<input type="hidden" name="condiTp" id="condiTp" value="SMS" />
	 	<input type="hidden" name="msgRoleCd" id="msgRoleCd" value="${smsInfo.msgRoleCd}" />
	 	<input type="hidden" name="msgDivRc" id="msgDivRc" value="${smsInfo.msgDivRc}" />
