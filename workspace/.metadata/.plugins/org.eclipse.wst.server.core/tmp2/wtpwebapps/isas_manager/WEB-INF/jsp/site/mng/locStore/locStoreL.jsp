...
// 		});
		...
		var dataAdapter = new $.jqx.dataAdapter({
            ...
            datafields: _datafields,
            url: contUrl + ".action",
            data: {boardMstCd: $("#boardMstCd").val(),
         	   addressLev1:$("#addressLev1").val(),
         	   addressLev2:$("#addressLev2").val(),
...
// 					$.paramData[j] =  row.boardSeq;
					$.mapStoreId[j] =  row.mapStoreId;	//20190516 ryul 수정
					j++;
				}
			}
			if(j == 0){
			...
			if(confirm("삭제하시겠습니까?")){
				fnAjax("locStoreD.action",  {"data":$.mapStoreId}, function(data, dataType){
