...
<script type="text/javaScript" defer="defer">
	var contUrl = "${rootUri}${conUrl}bbt00009";
		...
		,{ text: '수정', datafield: 'popButton', width: '5%', cellsalign: 'center', align: 'center',
			columntype: 'button', cellsrenderer: function () {
                ...
                var dataRecord = $("#jqxgrid").jqxGrid('getrowdata', row);
					$.fancybox.open({
						href: "bbt00009R.action?boardMstCd=${boardMstCd}&boardSeq="+ dataRecord.boardSeq,
						type: "iframe",
						maxWidth	: 1920,
						maxHeight	: 1100,
						width		: 1000,
	...
	function fnEvent(){
		...
		$("#registBtn").click(function(){
			$("#registBtn").attr("href","bbt00009R.action?boardMstCd=${boardMstCd}");
		});
		...
		$("#jqxgrid").on('celldoubleclick', function (event)
				{
					...
					$("#boardSeq").val(datarow.boardSeq);
						setTimeout(function(){
							$("#modifyBtn").attr("href","bbt00009R.action?boardMstCd=${boardMstCd}&boardSeq="+datarow.boardSeq);
							$("#modifyBtn").click();
						},200);
					}
				});
