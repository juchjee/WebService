...
<head>
	...
	<script type="text/javaScript" defer="defer">
		...
		function fnDataSetting() {
			...
			$("#dropDownButton").jqxDropDownButton('setContent', getTextElementByColor(new $.jqx.color({hex:"EFE7DC"})));
		}
...
<body class="noBg">
	...
	<form id="workForm" name="workForm" action="amM406S.action" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="bannerCd" value="${bannerCd}" />
		<input type="hidden" name="attchCd" value="${attchCd}" />
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td><html:selectList id="bannerLocalCd" name="bannerLocalCd" list='${eBanner}' listValue='bannerLocalCd' listName='bannerLocalNm' script='title="배너위치" style="width: 200px;"'/></td>
					</tr>
					<tr>
						<th scope="row">배너제목</th>
						<td><input type="text" name="bannerTitle" class="validation[required]" style="width:90%;" title="배너제목"/></td>
					</tr>
					...
					<tr>
						...
						<td><div class="fl"  style="margin-left:5px;" id="dropDownButton">
					...
					<tr>
						...
						<td>
							설정 기간동안 배너가 노출됩니다.
							<div class="marT10">
								<div class="fl" id='bannerStartDt'></div>
								<div class="fl" style="line-height:28px;">&nbsp;~&nbsp;</div>
								<div class="fl" id='bannerEndDt'></div>
							</div>
						</td>
					</tr>
<!-- 					<tr> -->
...
<!-- 						<td> -->
<!-- 							<div class="marT10"> -->
<%-- 								<div class="fl">등록일 : ${regDt}</div> --%>
<%-- 								<div class="fl marL30">등록자 : ${regNm}</div> --%>
<!-- 							</div> -->
<!-- 						</td> -->
<!-- 					</tr> -->
				</tbody>
