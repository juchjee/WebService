		...
		<div class="box_guide">
			...
			<div class="page_location">
				<ul>
					...
					<li class="last"><a href="javascript:;">제품메뉴얼</a></li>
				</ul>
			</div>
		</div>
		...
		<div id="box_tabs">
			...
			<div class="tab_container">
				<div id="tab4" class="tab_content" style="display:block;">
					...
					<div class="board">
						<table cellspacing="0">
							<caption>is 동서 빠른해결 제품메뉴얼입니다.</caption>
							<colgroup>
								<col style="width:85%"><col style="width:*">
							</colgroup>
							<tbody>
								<c:forEach items="${bbt9List}" var="bbt9" varStatus="status">
								<tr>
									<td class="subject" ><a href="javascript:;" class="tit" onclick="fnFileDownLoad('${bbt9.attchCd}');">${bbt9.boardTitle}</a><p class="dateInTit">${bbt9.regDt}</p></td>
									<td ><a href="javascript:;" class="btn01Type" onclick="fnFileDownLoad('${bbt9.attchCd}');">다운로드</a></td>
								</tr>
                    			</c:forEach>
                    			<c:if test="${empty bbt9List}">
                    			<tr>
