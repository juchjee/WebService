...
<head>
	...
	<!--
		...
		function newsCate(code,count){
			...
			document.newForm.action = "bbt00005.do?pageCd=BBM00002";
...
<div id="container" class="news">
	...
	<div id="contents" class="inner">
		<h3><img src="/common/images/tit/h3_tit8_4.png" alt="듀오락 소식"></h3>
		...
		<div id="tab_wrap">
			...
			<div id="tab01">
				...
				<div class="top_box">
					...
					<html:selectList name='sOrder' selectedValue="${param.sOrder}" optionValues='REG_DT|BOARD_HIT' optionNames='최신순|조회순' script='onchange="this.form.submit();"'/>
				</div>
				</form>
				...
				<ul class="bostyle02">
					<c:forEach items="${duoNewList}" var="duoNewList" varStatus="status">
						<li>
							...
							<c:if test="${empty duoNewList.imageTpLe}">
								<a href="${duoNewList.boardCont}" data-width="${duoNewList.imageWidth}" data-height="${duoNewList.imageHeight}" class="html5lightbox" data-group="all" title="${duoNewList.boardTitle}" onclick="hit_update('${duoNewList.boardSeq}')">
									<span class="img_box zitem">
										<img src="/common/img/duolac/noImgDuolac.jpg" alt="${duoNewList.boardTitle}" style="width:100%;height:70%;">
										<em class="ad"><c:out value="${duoNewList.boardCateNm}"/></em>
									</span>
									<span class="text_box">
										<strong><c:out value="${duoNewList.boardTitle}"/></strong>
