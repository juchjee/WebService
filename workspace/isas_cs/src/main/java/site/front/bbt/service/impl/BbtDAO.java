...
public class BbtDAO extends EgovAbstractDAO {
	...
	public List<?> bbt00002R(Map<String, Object> params) throws Exception {
		return list("BbtDAO.bbt00002R", params);
	}
	
	public int bbt00002Rcnt(Map<String, Object> params) throws Exception {
		return (int) select("BbtDAO.bbt00002Rcnt",params);
	}
	...
	public int bbt10ListCount(Map<String, Object> params) throws Exception {
		return (int) select("BbtDAO.bbt10ListCount", params);
	}
