...
<!--=============== #CONTAINER ===============-->
		<div id="container">
			...
			<div id="contents" class="inner">
				<h3><img src="/common/images/tit/h3_tit6_5.png" alt="이용약관"></h3>

				<ul class="rules">
					<li>
						<dl>
							<dt>제1조(목적)</dt>
							<dd>이 약관은 (주)쎌바이오텍인터내셔날(전자상거래 사업자)이 운영하는 듀오락(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 "몰" 이용자의 권리/의무 및 책임사항을 규정함을 목적으로 합니다. 「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」</dd>
						</dl>
					</li>
					<li>
						<dl>
							<dt>제2조(정의)</dt>
							<dd>① "몰" 이란 쎌바이오텍 가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.</dd>
					...
					<li>
						<dl>
							...
							<dd>① "몰"은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호/모사전송번호/전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 쎌바이오텍 의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.</dd>
							...
							<dd>④ “몰”이 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 몰의 초기화면에 그 적용일자 7일이전부터 적용일자 전일까지 공지합니다. 다만, 이용자에게 불리하게 약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다. 이 경우 "몰“은 개정전 내용과 개정후 내용을 명확하게 비교하여 이용자가 알기 쉽도록 표시합니다.	</dd>
					...
					<li>
						<dl>
							<dt>제5조(서비스의 중단)</dt>
							<dd>① “몰”은 컴퓨터 등 정보통신설비의 보수 점검.교체 및 고장, 통신의 두절 등의 사유가 발생한 경우에는 서비스의 제공을 일시적으로 중단할 수 있습니다.</dd>
					...
					<li>
						<dl>
							...
							<dd>② “몰”은 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중 다음 각호에 해당하지 않는 한 회원으로 등록합니다.
								<ul>
					...
					<li>
						<dl>
							...
							<dd>① 회원은 “몰”에 언제든지 탈퇴를 요청할 수 있으며 “몰”은 즉시 회원탈퇴를 처리합니다.
								<ul>
							...
							<dd>② 회원이 다음 각호의 사유에 해당하는 경우, “몰”은 회원자격을 제한 및 정지시킬 수 있습니다.</dd>
					...
					<li>
						<dl>
							<dt>제9조(구매신청)</dt>
							<dd>“몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, “몰”은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다. 단, 회원인 경우 제2호 내지 제4호의 적용을 제외할 수 있습니다.
								<ul>
					...
					<li>
						<dl>
							<dt>제10조 (계약의 성립)</dt>
							<dd>① “몰”은 제9조와 같은 구매신청에 대하여 다음 각호에 해당하면 승낙하지 않을 수 있습니다. 다만, 미성년자와 계약을 체결하는 경우에는 법정대리인의 동의를 얻지 못하면 미성년자 본인 또는 법정대리인이 계약을 취소할 수 있다는 내용을 고지하여야 합니다.
								<ul>
					...
					<li>
						<dl>
							<dt>제11조(지급방법)</dt>
							<dd>“몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각호의 방법중 가용한 방법으로 할 수 있습니다. 단, “몰”은 이용자의 지급방법에 대하여 재화 등의 대금에 어떠한 명목의 수수료도 추가하여 징수할 수 없습니다.
								<ul>
					...
					<li>
						<dl>
							...
							<dd>② “몰”은 이용자가 구매한 재화에 대해 배송수단, 수단별 배송비용 부담자, 수단별 배송기간 등을 명시합니다. 만약 “몰”이 약정 배송기간을 초과한 경우에는 그로 인한 이용자의 손해를 배상하여야 합니다. 다만 “몰”이 고의 과실이 없음을 입증한 경우에는
							그러하지 아니합니다.</dd>
						</dl>
					</li>
					<li>
					...
					<li>
						<dl>
							<dt>제15조(청약철회 등)</dt>
							<dd>① “몰”과 재화등의 구매에 관한 계약을 체결한 이용자는 수신확인의 통지를 받은 날부터 7일 이내에는 청약의 철회를 할 수 있습니다.</dd>
							<dd>② 이용자는 재화등을 배송받은 경우 다음 각호의 1에 해당하는 경우에는 반품 및 교환을 할 수 없습니다.
								<ul>
					...
					<li>
						<dl>
							<dt>제17조(개인정보보호)</dt>
							<dd>① “몰”은 이용자의 정보수집시 구매계약 이행에 필요한 최소한의 정보를 수집합니다. 다음 사항을 필수사항으로 하며 그 외 사항은 선택사항으로 합니다.
								<ul>
									<li>1. 성명</li>
									<li>2. 생년월일(회원의 경우)</li>
									<li>3. 성별(회원의 경우)</li>
									...
									<li>6. 희망ID(회원의 경우)</li>
									<li>7. 비밀번호(회원의 경우)</li>
									<li>8. 전자우편주소(또는 이동전화번호)</li>
								</ul>
							</dd>
							<dd>② “몰”이 이용자의 개인식별이 가능한 개인정보를 수집하는 때에는 반드시 당해 이용자의 동의를 받습니다.</dd>
							<dd>③ 제공된 개인정보는 당해 이용자의 동의없이 목적외의 이용이나 제3자에게 제공할 수 없으며, 이에 대한 모든 책임은 몰이 집니다. 다만, 다음의 경우에는 예외로 합니다.
								<ul>
					...
					<li>
						<dl>
							<dt>제18조(“몰“의 의무)</dt>
							<dd>① “몰”은 법령과 이 약관이 금지하거나 공서양속에 반하는 행위를 하지 않으며 이 약관이 정하는 바에 따라 지속적이고, 안정적으로 재화 및 용역을 제공하는데 최선을 다하여야 합니다.</dd>
					...
					<li>
						<dl>
							<dt>제23조(분쟁해결)</dt>
							<dd>① “몰”은 이용자가 제기하는 정당한 의견이나 불만을 반영하고 그 피해를 보상처리하기 위하여 피해보상처리기구를 설치ㆍ운영합니다.</dd>
					...
					<li>
						<dl>
							<dt>제24조(적립금 또는 마일리지)</dt>
							<dd>① “몰”이 이용자에게 회원가입시 또는 구매금액의 일정비율로 적립금 또는 마일리지를 제공할 수 있으며, 이용자별로 적립 사용에 대한 data base 관리를 합니다.</dd>
							<dd>② “몰”은 이용자의 적립금 또는 마일리지에 대하여 기한을 정하여 제8조 방법에 의하여 소진하도록 공지하고, 소진하지 않는 부문에 대해서는 취소할 수 있습니다.</dd>
						</dl>
					</li>
					<li>
						<dl>
							<dt>제25조(재판권 및 준거법)</dt>
