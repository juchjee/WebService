...
<body>
	...
	<div class="sub">
		...
		<div class="box_guide">
			...
			<!-- 20200427 ryul 법인분할 회사명칭 변경 -->	
<!-- 			<p class="desc">이누스  개인정보취급방침입니다.</p> -->
			<p class="desc">이누스 주식회사  개인정보취급방침입니다.</p>
		...
		<div class="box_terms type1">
			...
			<div class="inner">
				...
				<ul class="txt">
				<!-- 20200427 ryul 반기1회 > 년 1회 -->
<!-- 					<li class="square">정기적인 자체 감사 실시<br>개인정보 취급 관련 안정성 확보를 위해 정기적(반기 1회)으로 자체 감사를 실시하고 있습니다</li> -->
					<li class="square">정기적인 자체 감사 실시<br>개인정보 취급 관련 안정성 확보를 위해 정기적(년 1회)으로 자체 감사를 실시하고 있습니다</li>
...
<!-- 					<li class="square">연락처 : 02-3218-6873, foreverkhm@isdongseo.co.kr, 02-512-5100</li> -->
					<li class="square">성명 : 김헌욱</li>
					<li class="square">직급 : 부장</li>
					<li class="square">연락처 : 02-6989-1710, hukim@inushaus.com, 02-6989-1899(FAX)</li>
					<li class="square">※ 개인정보 보호 담당부서로 연결됩니다.<br></li>
				</ul>
				<p class="txt"><br>▶ 개인정보 보호 담당부서</p>
				<ul class="txt">
				<!-- 20200427 ryul 법인분할로 담당부서 변경 -->
...
<!-- 					<li class="square">연락처 : 02-3218-6836, 990029@isdongseo.co.kr , 02-512-5100</li> -->
					<li class="square">부서명 : 경영지원팀</li>
					<li class="square">담당자 : 강훈묵</li>
					<li class="square">연락처 : 02-6989-1711, foreverkhm@inushaus.com , 02-6989-1899(FAX)</li>
				</ul>
			...
			<div class="inner">
				...
				<ul class="txt">
				<!-- 20200427 ryul 법인분할로 접수·처리 부서 변경 -->
