...
<body>
			<div id="container">
				<div class="why_section">
					<div class="svisb">
						<img class="pt" src="/common/images/why/etc1_vis1.jpg" alt="우리 가족 장 건강은 세계특허 듀오락, 프로바이오틱스, 단백질 코팅, 다당류 코팅" />
						<img class="mobile" src="/common/images/why/mob_etc1_vis1.jpg" alt="우리 가족 장 건강은 세계특허 듀오락, 프로바이오틱스, 단백질 코팅, 다당류 코팅" />
					</div>
					<div class="only_content">
						<dl class="only_tit">
							<dt>
								<img class="pt" src="/common/images/why/etc1_tit1.png" alt="왜 Only One
								듀오락인가?" />
						...
						<ul class="only_list">
							<li class="li1">
								<a href="/ISDS/etc/etc.do?pageCd=SFM2">
									<dl>
										<dt><img src="/common/images/why/only_step1.png" alt="" /></dt>
										<dd>
							...
							<li class="li2">
								<a href="/ISDS/etc/etc.do?pageCd=SFM3">
									<dl>
										<dt><img src="/common/images/why/only_step2.png" alt="" /></dt>
										<dd>
											<p class="tit line2">안전성이 검증된 <br /><strong>한국형 프로바이오틱스</strong></p>
											<ul class="con">
						...
						<ul class="only_list">
							<li class="li1">
								<a href="/ISDS/etc/etc.do?pageCd=SFM4">
									<dl>
										<dt><img src="/common/images/why/only_step3.png" alt="" /></dt>
										<dd>
							...
							<li class="li2">
								<a href="/ISDS/etc/etc.do?pageCd=SFM5">
									<dl>
										<dt><img src="/common/images/why/only_step4.png" alt="" /></dt>
										<dd>
						...
						<ul class="only_list last">
							<li class="li1">
								<a href="/ISDS/etc/etc.do?pageCd=SFM6">
									<dl>
										<dt><img src="/common/images/why/only_step5.png" alt="" /></dt>
										<dd>
