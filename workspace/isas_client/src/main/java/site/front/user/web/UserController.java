...
//			params.put("MBR_ID", loginVO.getMbrId());
	...
	public String setting(@RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
		init(model);
		UnCamelMap<String, Object> paramMap = init(commandMap);
		...
		model.addAttribute("yTransMap", userService.mypageTransY(MBR_ID));
		return conUrl + "setting";
	}
