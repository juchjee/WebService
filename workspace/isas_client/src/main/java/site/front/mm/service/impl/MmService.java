...
//		vo.setMbrPw(enAdmPw);
		...
		if (loginVO != null && !loginVO.getCustCd().equals("") && !loginVO.getDrvNo().equals("")) {
			return loginVO;
		} else {
			return new LoginVO();
		}
	...
	public void joinI(String MBR_ID, UnCamelMap<String, Object> paramMap) throws Exception {
		...
		String MBR_SEQ = selectMaxMbrSeq();
		...
		commService.tableInatall("ASA010", paramMapMst, matchingColumName);
	}
	...
	public String  custNm(Map<String, Object> paramMap) {
        return mmDAO.custNm(paramMap);
	}


	public List<Map<String, Object>> aSZ130List(Map<String, Object> params) throws Exception {
        return mmDAO.aSZ130List(params);
    }

	public String loginChk(UnCamelMap<String, Object> paramMap) {
        return mmDAO.loginChk(paramMap);
	}
