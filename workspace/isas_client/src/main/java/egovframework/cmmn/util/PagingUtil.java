...
public class PagingUtil {
	...
	public String getMapPagesStrTag() {
		...
		if(getStartBlock() <= getEndBlock()){
			...
			htmlSB.append("<span class='next'><a href='javascript:;' onClick=\"doPage('" + this.getNextPageNum() + "')\">&gt;</a></span>");
			htmlSB.append("<span class='last'><a href='javascript:;' onClick=\"doPage('" + this.getNextBlock() + "')\">&gt;&gt;</a></span>");
			htmlSB.append("</div>");
			htmlSB.append("</div>");
			html = htmlSB.toString();
		}
