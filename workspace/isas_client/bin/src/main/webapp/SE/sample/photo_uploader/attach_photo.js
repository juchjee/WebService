    ...
    function html5Upload() {
    	...
    	sUploadURL= '/ISDS/saveImgsReturnUrls.action'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/ISDS/saveImgReturnUrl.action',	//URL입니다.
 	        sCallback : '/SE/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
