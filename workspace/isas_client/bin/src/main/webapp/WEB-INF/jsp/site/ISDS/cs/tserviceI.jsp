...
<head>
	...
	function fnEvent(){
		...
		$('.list_goods a').bind("click",function(){
			...
			$("#ascodeLev2").html("<option value=''>고장증상 중분류 </option>");
			$("#ascodeLev1").change();
			$.modelList($(this).index());
		});

		/*모델리스트*/
		$.modelList = function(tabCd){
			fnAjax("modelList.action", {"tabCd":tabCd},
					function(data, dataType){
	...
	<div class="sub">
		...
		<!--// step02 title -->
						...
						<div class="member">
							...
							<fieldset>
								...
								<div class="input_bx log" style="margin-top:20px;">
									...
									<input type="password" name="mbrPw" id="mbrPwA" placeholder="비밀번호" class="pw mt10" onkeydown="keydownAjax(1);"/>
				...
				<div class="rdi_bx_wrap l-conts-choose">
					...
					<div class="rdibox">
						<input type="radio" id="newif" class="" name="mbr" value=""><i></i>
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<input type="hidden" name="mbrNm" value="${mbrNm}" class="validation[required]" title="성명">
							</td>
						</tr>
						<tr>
